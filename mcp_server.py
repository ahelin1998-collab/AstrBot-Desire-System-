...
class DesireMCPServer:
    ...
    def tools(self) -> list[dict[str, Any]]:
        return [
            {"name": "desire_status",
             "description": "View the current nine-dimensional desire drive state.",
             "inputSchema": {"type": "object", "properties": {}, "required": []}},
            {"name": "desire_event",
             "description": "Trigger a desire system event.",
             "inputSchema": {"type": "object",
                             "properties": {"event_type": {"type": "string"}},
                             "required": ["event_type"]}},
            {"name": "desire_tick",
             "description": "Run one desire system heartbeat.",
             "inputSchema": {"type": "object", "properties": {}, "required": []}},
            {"name": "desire_sent_history",
             "description": "View recent messages sent via Bark.",
             "inputSchema": {"type": "object",
    ...
    def call_tool(self, name: str, arguments: dict[str, Any] | None) -> dict[str, Any]:
        ...
        elif name == "desire_log_reply":
            result = append_ai_reply(str(arguments.get("text", "")))
        ...
        if method == "initialize":
            return {"jsonrpc": "2.0", "id": request_id,
                    "result": {"protocolVersion": "2024-11-05",
                               "capabilities": {"tools": {}},
                               "serverInfo": {"name": "astrbot-desire-system",
                                              "version": "2.0.1"}}}
